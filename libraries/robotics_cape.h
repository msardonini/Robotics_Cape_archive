...
int initialize_imu_dmp(imu_data_t *data, imu_config_t conf, void* ptr);
...
int matrix_times_col_vec(matrix_t A, vector_t v, vector_t *output);
...
int vector_outer_product(vector_t v1, vector_t v2, matrix_t *out);
