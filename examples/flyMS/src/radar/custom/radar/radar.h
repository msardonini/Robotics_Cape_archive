/** @file
 *  @brief MAVLink comm protocol generated from radar.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_RADAR_H
#define MAVLINK_RADAR_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_RADAR.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_radar_param.h"
#include "./mavlink_msg_radar_command.h"
